            ...
            <div class="col-lg-6">
                <div class="card card-form-atraksi">
                    ...
                    <div class="card-form-atraksi-header">
                        ...
                        <h2>Edit Atraksi</h2>
                        <p>Perbarui informasi atraksi wisata</p>
                    </div>
    ...
    @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4"
                                          class="form-control form-atraksi-control @error('deskripsi') is-invalid @enderror">{{ old('deskripsi', $atraksi->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="jam_operasional" id="jam_operasional"
                                       ...
                                       value="{{ old('jam_operasional', $atraksi->jam_operasional) }}"
